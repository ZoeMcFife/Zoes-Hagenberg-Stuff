...
public class HealingPotionFactory
{
    ...
    static
    {
        ...
        registerPotion(20, "Emergency Tonic",            2.2, 80, 120, ItemRarity.HIGH);
        registerPotion(21, "Protectorate Med-Patch",     0.6, 65, 60, ItemRarity.LOW);
        ...
        registerPotion(26, "Soothing Infusion",          1.5, 35, 65, ItemRarity.MEDIUM);
        registerPotion(27, "Vital Essence",              1.6, 40, 70, ItemRarity.MEDIUM);
        registerPotion(28, "Healing Serum",              1.8, 45, 75, ItemRarity.MEDIUM);
        ...
        registerPotion(31, "Invigorating Elixir",        2.5, 60, 125, ItemRarity.HIGH);
        registerPotion(32, "Restorative Mixture",        2.7, 65, 130, ItemRarity.HIGH);
        registerPotion(33, "Guardian's Tonic",           3.0, 70, 130, ItemRarity.HIGH);
        registerPotion(34, "Celestial Draught",          3.2, 75, 135, ItemRarity.HIGH);
        registerPotion(35, "Mystic Infusion",            3.5, 80, 185, ItemRarity.LEGENDARY);
        registerPotion(36, "Ethereal Brew",              3.8, 85, 200, ItemRarity.LEGENDARY);
        registerPotion(37, "Astral Elixir",              4.0, 90, 200, ItemRarity.LEGENDARY);
        registerPotion(38, "Supreme Vitality Potion",    4.2, 95, 200, ItemRarity.LEGENDARY);
        registerPotion(39, "Primordial Tonic",           4.5, 100, 210, ItemRarity.LEGENDARY);
        registerPotion(40, "Arcane Health Vial",         4.8, 110, 225, ItemRarity.LEGENDARY);
        ...
        registerPotion(44, "Revitalizing Tonic",         1.6, 36, 80, ItemRarity.MEDIUM);
        registerPotion(45, "Potent Herbal Extract",      1.7, 40, 90, ItemRarity.MEDIUM);
        registerPotion(46, "Enchanted Healing Salve",    1.9, 45, 95, ItemRarity.MEDIUM);
        registerPotion(47, "Life Infusion",              2.1, 50, 100, ItemRarity.MEDIUM);
        registerPotion(48, "Greater Vitality Potion",    2.3, 55, 140, ItemRarity.HIGH);
        registerPotion(49, "Elixir of Recovery",         2.6, 60, 145, ItemRarity.HIGH);
        registerPotion(50, "Phoenix Feather Tonic",      2.8, 65, 150, ItemRarity.HIGH);
        registerPotion(51, "Regeneration Draught",       3.0, 70, 155, ItemRarity.HIGH);
        registerPotion(52, "Titan’s Brew",               3.3, 75, 160, ItemRarity.HIGH);
        registerPotion(53, "Divine Restorative",         3.5, 80, 230, ItemRarity.LEGENDARY);
        registerPotion(54, "Elixir of Eternal Health",   3.8, 90, 235, ItemRarity.LEGENDARY);
        registerPotion(55, "Mythic Healing Salve",       4.0, 95, 245, ItemRarity.LEGENDARY);
        registerPotion(56, "Lifeblood Potion",           4.2, 100, 245, ItemRarity.LEGENDARY);
        registerPotion(57, "Astral Vitality Draught",    4.5, 110, 260, ItemRarity.LEGENDARY);
        registerPotion(58, "Elder's Healing Elixir",     4.8, 120, 260, ItemRarity.LEGENDARY);
        registerPotion(59, "Primordial Restoration",     5.0, 130, 265, ItemRarity.LEGENDARY);
        registerPotion(60, "Supreme Health Vial",        5.2, 140, 275, ItemRarity.LEGENDARY);
        ...
        registerPotion(64, "Vitality Draught",           1.6, 36, 100, ItemRarity.MEDIUM);
        registerPotion(65, "Greater Healing Tonic",      1.8, 42, 110, ItemRarity.MEDIUM);
        registerPotion(66, "Potent Life Essence",        2.0, 48, 110, ItemRarity.MEDIUM);
        registerPotion(67, "Regenerative Elixir",       2.2, 52, 160, ItemRarity.HIGH);
        registerPotion(68, "Revival Brew",               2.4, 58, 170, ItemRarity.HIGH);
        registerPotion(69, "Lifeforce Tonic",            2.6, 60, 175, ItemRarity.HIGH);
        registerPotion(70, "Ultimate Vitality Potion",   2.8, 65, 175, ItemRarity.HIGH);
        registerPotion(71, "Ethereal Restoration",       3.0, 70, 280, ItemRarity.LEGENDARY);
        registerPotion(72, "Celestial Healing Brew",     3.3, 75, 190, ItemRarity.LEGENDARY);
        registerPotion(73, "Mythical Life Elixir",       3.5, 80, 290, ItemRarity.LEGENDARY);
