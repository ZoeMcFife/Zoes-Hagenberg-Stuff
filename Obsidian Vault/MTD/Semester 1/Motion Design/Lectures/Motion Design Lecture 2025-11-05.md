...
→ Lisa M. Gierlinger → professerin

Intro gerade

there’s a baby?????? 

still intro → she does animation stuff –> and also went to mtd a long time ago 

anima plus

she does a lot of stuff (motion design, animation, storyboarding, webdesign, etc)

Tutor → Christina Hohl → s2310872011@students.fh-hagenberg.at
...
- logo animation, titel animation, insert person, …….., lower third, bauchbinde, divider, trenner, export prores 444 quicktime 

pirringer project flaschbacks 

## Zeitlicher Ablauf

> “**letztes mal als ich versucht habe in After Effects zu animieren habe ich geweint**”
> → Average Pirringer Projekt in HTL Ybbs 
...
| Datum  | Vorlesung                                                      | Übungsblock                                                       |
| ------ | -------------------------------------------------------------- | ----------------------------------------------------------------- |
| 5.11.  | Technische Grundlagen 1                                        | Interface, Workflow, Import / Einstellung, Composition, Layer     |
| 11.11. | Technische Grundlagen 2: Farbe, Farbraum, Animationsprinzipien | **Abgabe 1:** Pfad- & Shapeanimation, Precomps, Keyframeanimation |
| 2.12.  | Communications & Visuelles Storytelling                        | Morphing, Textanimation, Style-Effekte anwenden                   |
| 17.12. | Typo in Motion, Art of Transitions                             | **Abgabe 2:** Szene mit Parallax-Effekt, Timing, Expressions      |
| 14.1.  | 5. Vorlesung                                                   | Abgabe 3                                                          |


> “Ziel dieses Kurses ist es eigenständig Motion Graphics in After Effects zu erstellen.”
