#modern_code #methods #syntax #ralsei_smokes_a_fat_blunt 

this is boring lol

![[ralsei_fat_blunt.png]]

omg ralsei no way ralsei is here no fucking way 
...
> ([[04_Methods.pdf#page=39&selection=4,0,4,5&color=red|04_Methods, p.32]])
> Scope


> ([[04_Methods.pdf#page=35&selection=4,22,4,52&color=red|04_Methods, p.28]])
> the reference (memory address)

> ([[04_Methods.pdf#page=36&selection=0,0,0,19&color=red|04_Methods, p.29]])
> "Global Variables" 
> ([[04_Methods.pdf#page=36&selection=2,8,3,1&color=red|04_Methods, p.29]])
> has no true globals;
> ([[04_Methods.pdf#page=36&selection=4,0,6,13&color=red|04_Methods, p.29]])
> static fields act like them
> ([[04_Methods.pdf#page=39&selection=9,0,9,15&color=red|04_Methods, p.32]])
> Local variables
> ([[04_Methods.pdf#page=39&selection=10,27,10,32&color=red|04_Methods, p.32]])
> block
> ([[04_Methods.pdf#page=39&selection=11,21,11,35&color=red|04_Methods, p.32]])
> method or loop
> ([[04_Methods.pdf#page=39&selection=12,3,12,41&color=red|04_Methods, p.32]])
> Cannot be accessed outside their block
> ([[04_Methods.pdf#page=39&selection=16,0,16,10&color=red|04_Methods, p.32]])
> Parameters
> ([[04_Methods.pdf#page=39&selection=17,2,17,22&color=red|04_Methods, p.32]])
> locals of the method
> ([[04_Methods.pdf#page=39&selection=23,0,24,38&color=red|04_Methods, p.32]])
